...
public class Warrior : Player, IColliderInfo
{
    #region 콜라이더 정보
    ...
    protected override void Init(Define.ObjectType objectType = Define.ObjectType.Player)
    {
        ...
        playerType = Define.PlayerType.Warrior;
    }
    ...
    protected override void InitStateMachine()
    {
        ...
        DashState dashState = new DashState(Define.State.Dash, this, controller, 3, 3, 1, 1);
        ...
        AttackState attackState = new AttackState(Define.State.NormalAttack, this, controller);
